define(["postmonger"], function (Postmonger) {
    ...
    function onInitActivity(data) {
        ...
        // Ensure the payload structure exists
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (!response.optInStatus) {
                    console.error("API response missing 'optInStatus'. Check API response structure.");
                    alert("API response is invalid. Check console for details.");
