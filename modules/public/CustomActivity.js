...
//         // Call the API with the correct format
//         $.ajax({
//             url: "https://splitbranch-ab8b48b255d1.herokuapp.com/execute", // Ensure this is the correct API endpoint
//             type: "POST",
//             contentType: "application/json",
//             data: JSON.stringify({
//                 inArguments: [{ phoneNumber: phoneNumber }]
...
//         // Check if the activity has been configured before updating
//         if (!payload.metaData.isConfigured) {
//             console.log("Activity is not configured yet. Updating...");
//             connection.trigger("updateActivity", payload); // Send update only once
//             connection.trigger("save"); // Save when configuration is finalized
//         } else {
//             console.log("Activity already configured.");
//         }
//     }
